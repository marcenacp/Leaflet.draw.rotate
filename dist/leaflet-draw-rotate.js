(function (factory) {
  ...
  L.Handler.PathTransform = L.Handler.extend({
    ...
    _createRotationHandlers: function () {
      ...
      this._rotationMarker = new RotateHandleClass(handlerPosition, this.options.handlerOptions).addTo(this._handlersGroup).on("mousedown", this._onRotateStart, this); //     const svgTemplate = `
