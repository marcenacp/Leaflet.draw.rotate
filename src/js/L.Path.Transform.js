...
L.Handler.PathTransform = L.Handler.extend({
  ...
  _createRotationHandlers: function () {
    ...
    const svgTemplate = `<svg height="512pt" viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg"><path d="m92.328125 283.84375c-1.546875-9.15625-2.328125-18.523438-2.328125-27.84375 0-94.988281 79.027344-166 166-166 38.675781 0 76.746094 14.148438 106.554688 39.230469l-9.960938 9.960937c-3.917969 3.917969-5.355469 9.671875-3.746094 14.972656 1.613282 5.296876 6.011719 9.277344 11.445313 10.351563.164062.03125 105.636719 21.246094 105.808593 21.28125 4.933594 1.007813 10.039063-.527344 13.601563-4.085937 3.5625-3.554688 5.101563-8.660157 4.097656-13.59375-.023437-.125-21.265625-105.730469-21.289062-105.859376-1.085938-5.421874-5.070313-9.808593-10.363281-11.414062-5.296876-1.601562-11.039063-.164062-14.953126 3.75l-10.960937 10.960938c-46.445313-41.6875-106.933594-65.554688-170.234375-65.554688-137.445312 0-256 112.347656-256 256 0 6.339844.234375 12.746094.703125 19.035156.496094 6.714844 5.40625 12.273438 12.007813 13.601563l61.875 12.410156c10.320312 2.070313 19.488281-6.863281 17.742187-17.203125zm-62.261719-22.324219c-.042968-1.84375-.066406-3.683593-.066406-5.519531 0-128.339844 106.75-226 226-226 59.246094 0 117.515625 24.445312 159.859375 67.070312 5.859375 5.898438 15.417969 5.914063 21.289063-.007812l1.4375-1.4375c.605468 3.007812-3.042969-15.144531 11.308593 56.246094-3.027343-.609375 15.171875 3.066406-56.207031-11.34375l1.117188-1.121094c5.839843-5.839844 5.859374-15.300781.046874-21.167969-36.6875-37.011719-87.296874-58.238281-138.851562-58.238281-102.722656 0-196 83.523438-196 196 0 3.859375.113281 7.730469.339844 11.589844zm0 0"/><path d="m499.324219 223.195312-61.929688-12.640624c-10.316406-2.105469-19.566406 6.824218-17.785156 17.226562 1.585937 9.273438 2.390625 18.769531 2.390625 28.21875 0 94.984375-79.027344 166-166 166-38.675781 0-76.746094-14.148438-106.554688-39.230469l9.960938-9.964843c3.917969-3.914063 5.355469-9.671876 3.746094-14.96875-1.613282-5.300782-6.015625-9.28125-11.449219-10.351563-.160156-.035156-105.632813-21.25-105.804687-21.28125-4.933594-1.007813-10.039063.527344-13.601563 4.082031-3.5625 3.558594-5.101563 8.664063-4.097656 13.597656.023437.125 21.265625 105.730469 21.289062 105.859376 1.085938 5.421874 5.070313 9.8125 10.363281 11.414062 5.292969 1.601562 11.042969.160156 14.953126-3.75l10.960937-10.960938c46.449219 41.691407 106.941406 65.554688 170.234375 65.554688 141.527344 0 256-113.984375 256-256 0-6.402344-.242188-12.871094-.71875-19.226562-.5-6.691407-5.382812-12.234376-11.957031-13.578126zm-243.324219 258.804688c-59.246094 0-117.515625-24.445312-159.859375-67.074219-5.859375-5.894531-15.417969-5.910156-21.289063.011719l-1.441406 1.4375c-.601562-3.011719 3.046875 15.144531-11.304687-56.25 3.027343.609375-15.171875-3.0625 56.210937 11.347656l-1.121094 1.121094c-5.839843 5.835938-5.859374 15.300781-.046874 21.164062 36.6875 37.015626 87.296874 58.242188 138.851562 58.242188 102.730469 0 196-83.546875 196-196 0-3.972656-.121094-7.949219-.359375-11.917969l30.289063 6.183594c.046874 1.914063.070312 3.828125.070312 5.734375 0 123.777344-99.273438 226-226 226zm0 0"/></svg>`;
    ...
    if (this._path._rings || this._path._parts) {
      ...
      for (let indexHandler = 0; indexHandler < 4; indexHandler++) {
        ...
        for (i = 0, len = rings.length; i < len; i++) {
          for (var j = 0, jj = rings[i].length; j < jj; j++) {
            if (
              latlngs[i][j].lat === handler._latlng.lat &&
              latlngs[i][j].lng === handler._latlng.lng
            ) {
        ...
        if (
          this._activeMarker.options.index ===
          (handler.options.index + 1) % 4
        ) {
