...
L.Handler.PathTransform = L.Handler.extend({
  ...
  _createRotationHandlers: function () {
    ...
    // </g>
    // </svg>`;
    const svgTemplate = `<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
width="458.228px" height="458.229px" viewBox="0 0 458.228 458.229" style="enable-background:new 0 0 458.228 458.229;"
xml:space="preserve">
<g>
